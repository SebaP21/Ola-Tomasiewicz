				...
				<article className='min-h-[90svh] w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] flex flex-col py-8 gap-4'>
					...
					<div className='flex flex-col gap-4'>
						...
						<p>
							...
							adresem url: olatomasiewicz.pl 2. Operatorem serwisu oraz
							Administratorem danych osobowych jest: Aleksandra Tomasiewicz
							Jesionowa 11,43-603 Jaworzno 3. Adres kontaktowy poczty
							elektronicznej operatora: ola.tomasiewicz.makeup@gmail.com 4.
							Operator jest Administratorem Twoich danych osobowych w
							odniesieniu do danych podanych dobrowolnie w Serwisie. 5. Serwis
							wykorzystuje dane osobowe w następujących celach: • Obsługa
							zapytań przez formularz • Realizacja zamówionych usług •
							Prezentacja oferty lub informacji 6. Serwis realizuje funkcje
							pozyskiwania informacji o użytkownikach i ich zachowaniu w
							następujący sposób: 1. Poprzez dobrowolnie wprowadzone w
							formularzach dane, które zostają wprowadzone do systemów
							Operatora. 2. Poprzez zapisywanie w urządzeniach końcowych plików
